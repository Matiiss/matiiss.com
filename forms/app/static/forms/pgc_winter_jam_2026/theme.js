const themeJson = {
  ...
  cssVariables: {
    ...
    "--sjs-base-unit": "8px",
    "--sjs-shadow-small": "3px 3px 2px 0px rgba(0, 0, 0, 0.15)",
    "--sjs-font-questiontitle-weight": "700",
    "--sjs-shadow-inner": "inset 3px 3px 2px 0px rgba(0, 0, 0, 0.15)",
    ...
    "--sjs-general-backcolor-dim": "#e4f0fb",
    "--sjs-primary-backcolor": "rgba(39, 114, 203, 1)",
